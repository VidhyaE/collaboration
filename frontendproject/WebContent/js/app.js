...
app.config(function($routeProvider){
   ...
   .when('/pendingrequests',{
    ...
    .when('/saveforumpost', {
    	templateUrl:'views/forumpostform.html',
    	controller:'ForumPostController'
    })
    .when('/getallforums',{
    	templateUrl:'views/forumslist.html',
    	controller:'ForumPostController'
    })
   .when('/getForumForApproval/:id',{
    	templateUrl:'views/approvalforumform.html',
    	controller:'ForumDetailController'
    })
    .when('/getForumDetail/:id',{
